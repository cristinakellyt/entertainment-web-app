      ...
      <form class="form" id="login-form" @submit.prevent="signup">
        ...
        <div class="form-group">
          <input
            ...
            required
          />
          <label class="form-group__label" for="password"> Confirm Password</label>
        </div>

        <div class="form-group__btns-options">
          <button type="submit" form="login-form">Create an account</button>
          <span class=""
...
const signup = () => {
  console.log('signup')
  //TODO: redirect to login page and clean form
}
</script>
